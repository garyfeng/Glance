...
function replacer(id){
      ...
      // garyfeng
      var iframe = '<div class="absolute-content"></div><iframe style="margin-left:7px;width: 99.9%" class="iframe_style" id="vis_tool_iframe'+id+'"  height="'+height+'" src="../vis_tools/?session='+value+'&details=false&embedded=true" frameborder="0"></iframe>';
...
function add_values_to_bar(){
  ...
  // garyfeng
  var iframe = '<iframe style="margin-left:7px;width: 99.9%" class="iframe_style" id="vis_tool_iframe'+counter+'" width="95%" height="'+height+'" src="../vis_tools/?session='+value+'&details=false&embedded=true" frameborder="0"></iframe>';
